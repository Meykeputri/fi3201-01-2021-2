...
```
Kode diatas berffungsi untuk memvisualisasikan suatu keadaan gelombang yang berosilasi pada arah tegak lurus sumbu x dan merambat pada sumbu x.
```
...
![gif file from simulation wave to right](assignment-04.gif)
...
```
dan hasil berkas gifnya adalah \
![gif file from simulation wave to left](assignment-04(1).gif)
...
```
dan hasil berkas gifnya adalah \
![gif file from simulation wave stationary](assignment-04(2).gif)
